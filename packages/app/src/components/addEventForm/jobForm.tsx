/** A job starts or changes income — a JobChangeEvent. */
...
export function JobForm({
  ...
  // Attribute income to someone in the household when the job starts. Derived
  ...
  function submit() {
    onAdd({
      ...
      annualIncomeCents: dollarsToCents(amount * 12),
  ...
  return (
    <>
      ...
      <NumInput label="Monthly income" value={amount} onChange={setAmount} prefix="$" step={100} />
      {owners.length > 1 && (
