...
export interface ContinuedJob {
   ...
   * ({@link import("../compile/compilePerson").jobDisplayNames}): its own name, or its owner's ("Alex's
 ...
 * (see {@link import("../plan/person").Person.continuationJobId}), so a household where everyone
