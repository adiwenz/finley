 ...
 * the run's own — shared by {@link computeLiabilityPayments} so a balance passed explicitly prices
 * exactly as the run's own would.
 *
 ...
 * and the payment actually funded, in that order. PURE.
 */
