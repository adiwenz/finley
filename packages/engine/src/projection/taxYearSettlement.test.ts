...
describe("finalizing a tax year — the payroll-tax reconciliation rides on the same balance", () => {
  ...
  function stateWithTwoEmployers(): SimState {
    ...
    state.sourceYearToDate.set(
      "p1|2026",
      new Map([
        ["jobA", { earnedByCategory: { wages: dollarsToCents(80_000) }, supplementalWagesCents: 0, wageWithholdingCents: 0 }],
        ["jobB", { earnedByCategory: { wages: dollarsToCents(80_000) }, supplementalWagesCents: 0, wageWithholdingCents: 0 }],
      ]),
    );
    return state;
  }
