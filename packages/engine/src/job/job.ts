 ...
 * held by a {@link import("../plan/person").Person} and compiles into the simulator via
 ...
 * outside themselves: {@link import("../plan/person").Person.continuationJobId} holds one, and a field
