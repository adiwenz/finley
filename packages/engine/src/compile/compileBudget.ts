 ...
 * jurisdiction seam; isolating it keeps {@link import("../budget/budgetLine")}'s pure types free of
...
import type { Jurisdiction, DeferralLimitContext } from "../jurisdiction/jurisdiction";
import { budgetLinePriority, type BudgetLine } from "../budget/budgetLine";
