 ...
 *   reconciled — see {@link import("../job/job").SalaryTrajectory}.
 ...
 *   Reconstructing an unstated year is a dated {@link import("../job/job").JobPayChange} the user
...
import { SimCashFlowSeries, type GrowthMode } from "../money/cashFlowSeries";
 ...
 * {@link import("../job/job").JobPayChange}, which the reconstruction reads. Growth belongs to the
